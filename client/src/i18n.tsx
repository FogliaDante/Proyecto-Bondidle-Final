...
const resources: Record<Lang, Dict> = {
  es: {
    ...
    'history.stats': 'Tus Estadísticas',
    'history.totalGames': 'Juegos Totales',
    'history.gamesWon': 'Juegos Ganados',
    'history.avgAttempts': 'Promedio Intentos',
    'history.bestResult': 'Mejor Resultado',
    'history.noGames': 'No hay juegos registrados aún. ¡Empieza a jugar!',
    'history.completed': 'Completado',
    'history.notCompleted': 'No completado',
    'history.attempt': 'intento',
    'history.attempts': 'intentos',
    'history.attemptsList': 'Intentos:',
    'history.loading': 'Cargando...',

    // Ranking
    'ranking.title': 'Ranking Global',
    'ranking.subtitle': 'Los mejores jugadores de Bondidle',
    'ranking.noData': 'No hay datos de ranking aún.',
    'ranking.position': 'Pos.',
    'ranking.player': 'Jugador',
    'ranking.played': 'Jugados',
    'ranking.won': 'Ganados',
    'ranking.avgAttempts': 'Prom. Int.',

    // Admin Dashboard
    'admin.title': 'Panel de Administración',
    'admin.stats': 'Estadísticas',
    'admin.dailyBus': 'Bondi del Día',
    'admin.buses': 'Colectivos',
    'admin.users': 'Usuarios',
    'admin.totalUsers': 'Usuarios Totales',
    'admin.totalBuses': 'Colectivos',
    'admin.totalGames': 'Juegos Jugados',
    'admin.gamesWon': 'Juegos Ganados',
    'admin.gamesToday': 'Juegos Hoy',
    'admin.busOfDay': 'Bondi del Día',
    'admin.busNumber': 'Colectivo',
    'admin.branch': 'Ramal',
    'admin.zone': 'Zona',
    'admin.start': 'Inicio',
    'admin.end': 'Final',
    ...
    'admin.busesList': 'Colectivos',
    'admin.branches': 'ramales',
    'admin.usersList': 'Usuarios',
    'admin.games': 'juegos',
    'admin.registration': 'Registro',
    'admin.errorStats': 'Error al cargar estadísticas del sistema',
    'admin.errorBuses': 'Error al cargar colectivos. Verifica que tengas permisos de administrador.',
    'admin.errorUsers': 'Error al cargar usuarios. Verifica que tengas permisos de administrador.',
    'admin.errorDailyBus': 'Error al cargar bondi del día. Verifica que tengas permisos de administrador.',
  },
  ...
  en: {
    ...
    'history.stats': 'Your Statistics',
    'history.totalGames': 'Total Games',
    'history.gamesWon': 'Games Won',
    'history.avgAttempts': 'Average Attempts',
    'history.bestResult': 'Best Result',
    'history.noGames': 'No games recorded yet. Start playing!',
    'history.completed': 'Completed',
    'history.notCompleted': 'Not completed',
    'history.attempt': 'attempt',
    'history.attempts': 'attempts',
    'history.attemptsList': 'Attempts:',
    'history.loading': 'Loading...',

    // Ranking
    'ranking.title': 'Global Ranking',
    'ranking.subtitle': 'The best Bondidle players',
    'ranking.noData': 'No ranking data yet.',
    'ranking.position': 'Pos.',
    'ranking.player': 'Player',
    'ranking.played': 'Played',
    'ranking.won': 'Won',
    'ranking.avgAttempts': 'Avg. Att.',

    // Admin Dashboard
    'admin.title': 'Admin Dashboard',
    'admin.stats': 'Statistics',
    'admin.dailyBus': 'Daily Bus',
    'admin.buses': 'Buses',
    'admin.users': 'Users',
    'admin.totalUsers': 'Total Users',
    'admin.totalBuses': 'Buses',
    'admin.totalGames': 'Games Played',
    'admin.gamesWon': 'Games Won',
    'admin.gamesToday': 'Games Today',
    'admin.busOfDay': 'Bus of the Day',
    'admin.busNumber': 'Bus',
    'admin.branch': 'Branch',
    'admin.zone': 'Zone',
    'admin.start': 'Start',
    ...
    'admin.colors': 'Colors',
    'admin.busesList': 'Buses',
    'admin.branches': 'branches',
    'admin.usersList': 'Users',
    'admin.games': 'games',
    'admin.registration': 'Registration',
    'admin.errorStats': 'Error loading system statistics',
    'admin.errorBuses': 'Error loading buses. Verify you have administrator permissions.',
    'admin.errorUsers': 'Error loading users. Verify you have administrator permissions.',
    'admin.errorDailyBus': 'Error loading daily bus. Verify you have administrator permissions.',
  }
};
